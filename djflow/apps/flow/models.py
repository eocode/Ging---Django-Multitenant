...
class Account(models.Model):
    ...
    Cuentas del usuario
    """
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, help_text=_("Usuario que ha creado la cuenta"))
...
class Transaction(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, help_text=_("Usuario que ha creado la cuenta"))
    account = models.ForeignKey(Account, on_delete=models.CASCADE, help_text=_("Cuenta a afectar"),
                                verbose_name=_("Cuenta"))
...
class TransactionComment(models.Model):
    transaction = models.ForeignKey(Transaction, on_delete=models.CASCADE, verbose_name=_("Transacción"))
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name=_("Usuario"))
